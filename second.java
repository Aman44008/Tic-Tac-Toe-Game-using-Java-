...
class f {
    ...
    // creating class constructor for creating home page
    f() {
        ...
        text.setFont(new Font("BLOODY TYPE PERSONAL USE", Font.BOLD, 80));
        text.setBackground(new Color(250, 0, 0));
        text.setForeground(new Color(166, 16, 30));
        text.setHorizontalAlignment(JLabel.CENTER);
        frame.add(text);

        JButton Multi = new JButton("Play with Friend");
        Multi.setBounds(40, 350, 190, 40);
        Multi.setFont(new Font("chiller", Font.PLAIN, 25));
        frame.add(Multi);
        ...
        JButton s = new JButton("Play with Computer");
        s.setBounds(260, 350, 190, 40);
        s.setFont(new Font("chiller", Font.PLAIN, 25));
        frame.add(s);
...
class player implements ActionListener {
    ...
    // Method for performing user turn
    @Override
    public void actionPerformed(ActionEvent e) {
        for (int i = 0; i < 9; i++) {
    ...
    // creating method for computer turn
    public void compTurn() {
        if (counter == 0) {
            if (bton[0].getText() == "X") {
                bton[4].setForeground(new Color(0, 255, 9));
                bton[4].setText("O");
                counter++;
                chance_flag++;
                matchCheck();
            ...
            } else if (bton[7].getText() == "") {
                bton[7].setForeground(new Color(0, 255, 9));
                bton[7].setText("O");
                counter++;
                chance_flag++;
                matchCheck();
            ...
            } else if (bton[4].getText() == "X") {
                bton[0].setForeground(new Color(0, 255, 9));
                bton[0].setText("O");
                counter++;
                chance_flag++;
                matchCheck();
        ...
        if (counter == 1) {
            if (bton[0].getText() == "X" && bton[1].getText() == "X") {
                bton[2].setForeground(new Color(0, 255, 9));
                bton[2].setText("O");
                counter++;
                chance_flag++;
                matchCheck();
            ...
            } else if (bton[0].getText() == "X" && bton[3].getText() == "X") {
                bton[6].setForeground(new Color(0, 255, 9));
                bton[6].setText("O");
                counter++;
                chance_flag++;
                matchCheck();
            ...
            } else if (bton[1].getText() == "X" && bton[2].getText() == "X") {
                bton[0].setForeground(new Color(0, 255, 9));
                bton[0].setText("O");
                counter++;
                chance_flag++;
            ...
            } else if (bton[3].getText() == "") {
                bton[3].setForeground(new Color(0, 255, 9));
                bton[3].setText("O");
                counter++;
                chance_flag++;
                matchCheck();
            ...
            } else if (bton[8].getText() == "") {
                bton[8].setForeground(new Color(0, 255, 9));
                bton[8].setText("O");
                counter++;
                chance_flag++;
                matchCheck();
            ...
            } else if (bton[1].getText() == "") {
                bton[1].setForeground(new Color(0, 255, 9));
                bton[1].setText("O");
                counter++;
                chance_flag++;
                matchCheck();
            ...
            } else if (bton[5].getText() == "") {
                bton[5].setForeground(new Color(0, 255, 9));
                bton[5].setText("O");
                counter++;
                chance_flag++;
                matchCheck();
        ...
        if (counter == 2) {
            if (bton[0].getText() == "X" && bton[1].getText() == "X" && bton[6].getText() == "X") {
                bton[3].setForeground(new Color(0, 255, 9));
                bton[3].setText("O");
                counter++;
                chance_flag++;
            ...
            } else if (bton[1].getText() == "X" && bton[2].getText() == "X" && bton[8].getText() == "X") {
                bton[5].setForeground(new Color(0, 255, 9));
                bton[5].setText("O");
                counter++;
                chance_flag++;
